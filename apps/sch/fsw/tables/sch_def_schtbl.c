...
/*
** Index of entry in sch_def_msgtbl for the corresponding message
*/

#define EPS_WAKEUP_MIDX         32
#define EPS_SEND_HK_MIDX        33
#define COMMS_WAKEUP_MIDX       34
#define COMMS_SEND_HK_MIDX      35
#define PAYLOAD_WAKEUP_MIDX     36
#define PAYLOAD_SEND_HK_MIDX    37
...
/*{  SCH_DISABLED, SCH_ACTIVITY_SEND_MSG,  1,  0, 24, SCH_GROUP_MD_WAKEUP }, */  /* MD Wakeup */
  ...
  /* slot #6 - EPS WakeUp */
  {  SCH_ENABLED,   SCH_ACTIVITY_SEND_MSG, 1, 0, EPS_WAKEUP_MIDX, SCH_GROUP_NONE}, /*EPS WAKEUP*/
  {  SCH_UNUSED,   0,      0,  0, 0,  SCH_GROUP_NONE},
  {  SCH_UNUSED,   0,      0,  0, 0,  SCH_GROUP_NONE},
  {  SCH_UNUSED,   0,      0,  0, 0,  SCH_GROUP_NONE},
  {  SCH_UNUSED,   0,      0,  0, 0,  SCH_GROUP_NONE},
  ...
  /* slot #7 - EPS SEND HK */
  {  SCH_ENABLED, SCH_ACTIVITY_SEND_MSG, 1, 0, EPS_SEND_HK_MIDX, SCH_GROUP_NONE}, /* EPS SENDHK*/
  {  SCH_UNUSED,   0,      0,  0, 0,  SCH_GROUP_NONE},
  {  SCH_UNUSED,   0,      0,  0, 0,  SCH_GROUP_NONE},
  {  SCH_UNUSED,   0,      0,  0, 0,  SCH_GROUP_NONE},
  {  SCH_UNUSED,   0,      0,  0, 0,  SCH_GROUP_NONE},
  ...
  /* slot #8 */
  {  SCH_ENABLED,   SCH_ACTIVITY_SEND_MSG, 1, 0, COMMS_WAKEUP_MIDX,  SCH_GROUP_NONE}, /*COMMS WAKEUP*/
  {  SCH_UNUSED,   0,      0,  0, 0,  SCH_GROUP_NONE},
  {  SCH_UNUSED,   0,      0,  0, 0,  SCH_GROUP_NONE},
  {  SCH_UNUSED,   0,      0,  0, 0,  SCH_GROUP_NONE},
  {  SCH_UNUSED,   0,      0,  0, 0,  SCH_GROUP_NONE},
  ...
  /* slot #9 */
  {  SCH_ENABLED,   SCH_ACTIVITY_SEND_MSG, 1, 0, COMMS_SEND_HK_MIDX,  SCH_GROUP_NONE}, /*COMMS SEND HK*/
/*{  SCH_DISABLED, SCH_ACTIVITY_SEND_MSG,  4,  2,  7, SCH_GROUP_CFS_HK }, */  /* DS HK Request */
  ...
  /* slot #10 */
  {  SCH_ENABLED,   SCH_ACTIVITY_SEND_MSG, 1, 0, PAYLOAD_WAKEUP_MIDX,  SCH_GROUP_NONE}, /*PAYLOAD WAKEUP*/
/*{  SCH_DISABLED, SCH_ACTIVITY_SEND_MSG,  1,  0, 24, SCH_GROUP_MD_WAKEUP }, */  /* MD Wakeup */
  {  SCH_UNUSED,   0,      0,  0, 0,  SCH_GROUP_NONE},
  {  SCH_UNUSED,   0,      0,  0, 0,  SCH_GROUP_NONE},
  {  SCH_UNUSED,   0,      0,  0, 0,  SCH_GROUP_NONE},
  ...
  /* slot #11 */
  {  SCH_ENABLED,   SCH_ACTIVITY_SEND_MSG, 1, 0, PAYLOAD_SEND_HK_MIDX,  SCH_GROUP_NONE}, /*PAYLOAD SEND HK*/
  {  SCH_UNUSED,   0,      0,  0, 0,  SCH_GROUP_NONE},
  {  SCH_UNUSED,   0,      0,  0, 0,  SCH_GROUP_NONE},
  {  SCH_UNUSED,   0,      0,  0, 0,  SCH_GROUP_NONE},
  {  SCH_UNUSED,   0,      0,  0, 0,  SCH_GROUP_NONE},
