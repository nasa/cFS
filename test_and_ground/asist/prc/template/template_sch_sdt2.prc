...
s create_tbl_file_from_cvt ("$CPU",tblAppId,"SCH Full Schedule Definition Table","sch_def_sdt2.tbl",SCHDefTblName,"$SC_$CPU_SCH_DefaultScheduleTable[0]",endMnemonic)
