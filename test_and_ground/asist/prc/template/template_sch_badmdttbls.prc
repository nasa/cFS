...
s create_tbl_file_from_cvt ("$CPU",tblAppId,"SCH Message Definition Table Req_2007","mdt_20071.tbl",MSGDefTblName,"$SC_$CPU_SCH_DefaultMessageTable[0]",endMnemonic)
...
;; Create the Table Load file
s create_tbl_file_from_cvt ("$CPU",tblAppId,"SCH Message Definition Table Req_2007","mdt_20072.tbl",MSGDefTblName,"$SC_$CPU_SCH_DefaultMessageTable[0]",endMnemonic)
...
;; Create the Table Load file
s create_tbl_file_from_cvt ("$CPU",tblAppId,"SCH Message Definition Table Req_2007","mdt_20073.tbl",MSGDefTblName,"$SC_$CPU_SCH_DefaultMessageTable[0]",endMnemonic)
...
;; Create the Table Load file
s create_tbl_file_from_cvt ("$CPU",tblAppId,"SCH Message Definition Table Req_2007","mdt_20074.tbl",MSGDefTblName,"$SC_$CPU_SCH_DefaultMessageTable[0]",endMnemonic)
...
;; Create the Table Load file
s create_tbl_file_from_cvt ("$CPU",tblAppId,"SCH Message Definition Table Req_2007","mdt_20075.tbl",MSGDefTblName,"$SC_$CPU_SCH_DefaultMessageTable[0]",endMnemonic)
...
;; Create the Table Load file
s create_tbl_file_from_cvt ("$CPU",tblAppId,"SCH Message Definition Table Req_2007","mdt_20076.tbl",MSGDefTblName,"$SC_$CPU_SCH_DefaultMessageTable[0]",endMnemonic)
...
;; Create the Table Load file
s create_tbl_file_from_cvt ("$CPU",tblAppId,"SCH Message Definition Table Req_2007","mdt_20077.tbl",MSGDefTblName,"$SC_$CPU_SCH_DefaultMessageTable[0]",endMnemonic)
