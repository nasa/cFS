/*
** $Id: sch_def_schtbl4.c 1.2 2015/03/01 14:01:33EST sstrege Exp  $
**
...
** Notes:
**
** $Log: sch_def_schtbl4.c  $
** Revision 1.2 2015/03/01 14:01:33EST sstrege 
** Added copyright information
** Revision 1.1 2011/06/30 21:01:09EDT aschoeni 
** Initial revision
...
static CFE_TBL_FileDef_t CFE_TBL_FileDef =
{
    ...
    "sch_def_schtbl4.tbl", (sizeof(SCH_ScheduleEntry_t) * SCH_TABLE_ENTRIES)
};
...
*/
  ...
  {  SCH_UNUSED,   0,      0,  0, 0,  SCH_GROUP_NONE},                                        
  {  SCH_UNUSED,   0,      0,  0, 0,  SCH_GROUP_NONE},                                        
  {  SCH_ENABLED,   SCH_ACTIVITY_SEND_MSG,      2,  2, 0,  SCH_GROUP_NONE}, /* Slot #50, Entry #4 - Remainder >= Frequency */                                       
