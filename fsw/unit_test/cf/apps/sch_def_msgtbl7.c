/*
** $Id: sch_def_msgtbl7.c 1.2 2015/03/01 14:01:48EST sstrege Exp  $
**
...
** Notes:
**
** $Log: sch_def_msgtbl7.c  $
** Revision 1.2 2015/03/01 14:01:48EST sstrege 
** Added copyright information
** Revision 1.1 2011/06/30 21:00:19EDT aschoeni 
** Initial revision
...
static CFE_TBL_FileDef_t CFE_TBL_FileDef =
{
    ...
    "sch_def_msgtbl7.tbl", (sizeof(SCH_MessageEntry_t) * SCH_MAX_MESSAGES)
}; 
...
SCH_MessageEntry_t SCH_DefaultMessageTable[SCH_MAX_MESSAGES] =
{
  ...
  */
  ...
  { { SCH_UNUSED_MID } },
    ...
    /* command ID #20 */
  { { SCH_UNUSED_MID, 0, 0, 0, 0xC000, 0x0001 } },
    /* command ID #21 */
  { { SCH_UNUSED_MID } },
    /* command ID #22 */
  { { SCH_UNUSED_MID } },
