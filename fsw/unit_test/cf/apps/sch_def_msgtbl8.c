...
** Notes:
**
** $Log: sch_def_msgtbl8.c  $
** Revision 1.2 2015/03/01 14:01:31EST sstrege 
** Added copyright information
** Revision 1.1 2011/06/30 21:00:27EDT aschoeni 
** Initial revision
...
static CFE_TBL_FileDef_t CFE_TBL_FileDef =
{
    ...
    "sch_def_msgtbl8.tbl", (sizeof(SCH_MessageEntry_t) * SCH_MAX_MESSAGES)
}; 
...
SCH_MessageEntry_t SCH_DefaultMessageTable[SCH_MAX_MESSAGES] =
{
  ...
  */
  ...
  { { SCH_UNUSED_MID } },
    /* command ID #21 */
  { { CFE_SB_HIGHEST_VALID_MSGID + 2, 0xC000, 0x0001, 0x0000 } },
    /* command ID #22 */
  { { SCH_UNUSED_MID } },
    /* command ID #23 */
  { { SCH_UNUSED_MID } },
