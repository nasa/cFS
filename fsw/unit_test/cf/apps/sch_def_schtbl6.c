/*
** $Id: sch_def_schtbl6.c 1.2 2015/03/01 14:01:39EST sstrege Exp  $
**
...
** Notes:
**
** $Log: sch_def_schtbl6.c  $
** Revision 1.2 2015/03/01 14:01:39EST sstrege 
** Added copyright information
** Revision 1.1 2011/06/30 21:01:13EDT aschoeni 
** Initial revision
...
static CFE_TBL_FileDef_t CFE_TBL_FileDef =
{
    ...
    "sch_def_schtbl6.tbl", (sizeof(SCH_ScheduleEntry_t) * SCH_TABLE_ENTRIES)
};
...
*/
  ...
  /* slot #0 */
  {  SCH_ENABLED, SCH_ACTIVITY_SEND_MSG,  1,  0, 8, 0x00000001}, /* Slot #0, Entry #0 - Enabled - Message #0 every second (Multi-Group #0001B) */
  ...
  /* slot #51 */
  {  SCH_UNUSED,   0,      0,  0, 0,  SCH_GROUP_NONE},                                        
  {  SCH_ENABLED,   SCH_ACTIVITY_SEND_MSG,      2,  0, SCH_MAX_MESSAGES,  SCH_GROUP_NONE}, /* Slot #51, Entry #1 - Msg Index out of bounds */                                       
  {  SCH_UNUSED,   0,      0,  0, 0,  SCH_GROUP_NONE},                                        
  {  SCH_UNUSED,   0,      0,  0, 0,  SCH_GROUP_NONE},                                        
  {  SCH_UNUSED,   0,      0,  0, 0,  SCH_GROUP_NONE},                                        
